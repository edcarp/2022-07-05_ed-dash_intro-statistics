...
humandate: "5-8 July 2022"    # human-readable dates for the workshop (e.g., "Feb 17-18, 2020")
...
instructor: ["Hannes Becher", "Nathan Constantine-Cooke"] # boxed, comma-separated list of instructors' names as strings, like ["Kay McNulty", "Betty Jennings", "Betty Snyder"]
helper: ["Barry Ryan"]     # boxed, comma-separated list of helpers' names, like ["Marlyn Wescoff", "Fran Bilas", "Ruth Lichterman"]
...
The workshop assumes no prior experience of statistical analysis in R. However,
learners are expected to have some familiarity with R such as having done an
...
This lesson was designed for researchers interested in working with public 
health data in R, but may be of interest to researchers in other fields as well.


This first day provides an introduction to statistical concepts commonly used 
for linear modelling. This portion covers mean estimation, linear association
and mean prediction.
This second day provides an introduction to simple linear regression. 
The episodes cover the concept of simple linear regression, and the use of simple
linear regression with various types of predictor variables.
The third day covers assessment of model fit and 
assumptions. The fourth day provides an introduction to linear regression with 
more than one explanatory variable. This is known as multiple linear regression,
as the model has multiple explanatory variables. The first episode of this day
covers how to fit and interpret models with one continuous and one categorical
explanatory variable. In the second episode, these models are expanded by 
including an interaction between the two explanatory variables. In the third 
episode predictions of the mean are covered. The final episode covers model fit
and assessment of model assumptions.
